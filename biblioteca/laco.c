...
/* 
 ...
 A estrutura LABEL/GOTO permite rotular (portanto LABEL) um determinado ponto do código como um ponto de referência, permitindo que a execução salte para esse 
 ponto de referência quando encontrar um GOTO.
 ...
 No seu uso, ele permite que sejam definidos os três parâmetros de funcionamento, no entanto, os mesmos não são obrigatórios.
...
imprimir:
	...
	// O i é impresso através de uma repetição em loop, com uso da estrutura FOR e seu cabeçalho preenchido plenamente
	...
	// O i é impresso através de uma repetição em loop, com o uso da estrutura FOR sem seus parâmetros.
	// São usados o pós-incremento, o BREAK e o CONTINUE para estabelecer os parâmetros
